...
module.exports = {
  ...
  networks: {
    ganache: {
      host: "127.0.0.1",     // Localhost (default: none)   // truffle.cmd migrate --network ganache 
      port: 7545,            // Standard BSC port (default: none)
      network_id: "1337",       // Any network (default: none)
    },
    testnet: {
      provider: () => new HDWalletProvider(mnemonic, `https://data-seed-prebsc-1-s1.binance.org:7545/`),
      network_id: 97,
      gas: 5500000,
